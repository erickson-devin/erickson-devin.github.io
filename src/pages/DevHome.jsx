...
function BackToAuthor() {
  return (
    <div
      className="border-b border-[#1e293b] px-6 py-2.5 flex items-center"
...
function HeroSection() {
  return (
    <section
      id="dev-hero"
      className="relative min-h-[calc(100vh-2.5rem)] flex items-center overflow-hidden px-6"
    >
      ...
      <div aria-hidden="true" className="pointer-events-none absolute inset-0">
        ...
        <div className="absolute bottom-0 right-0 w-[500px] h-[500px] rounded-full bg-violet-600/15 blur-[100px] animate-pulse-slow animate-delay-300" />
        <div
      ...
      <div className="relative max-w-6xl mx-auto w-full grid lg:grid-cols-2 gap-16 items-center py-24">
        ...
        <div className="flex flex-col gap-6 animate-fade-up">
          {/* Available badge */}
          <div className="inline-flex items-center gap-2 w-fit px-3 py-1.5 rounded-full border border-emerald-500/30 bg-emerald-500/10 text-emerald-400 text-xs font-medium">
            <PulseDot />
  ...
  return (
    <div className="hidden lg:flex justify-center items-center animate-fade-up animate-delay-200">
      <div className="relative">
        ...
        <div className="relative rounded-2xl overflow-hidden border border-white/10 shadow-2xl shadow-black/50 w-72 h-80">
          <img
            src="/assets/Erickson_Fam_2017.jpg"
            alt="Devin Erickson"
            className="w-full h-full object-cover object-top"
          />
          <div className="absolute inset-x-0 bottom-0 h-1/3 bg-gradient-to-t from-[#0f172a]/80 to-transparent" />
        </div>
        <div className="absolute -bottom-4 -left-4 card px-4 py-2 rounded-xl text-xs font-mono border-brand-500/30 shadow-xl flex items-center gap-2">
          <span className="text-brand-400">{'<'}</span>
          <span className="text-slate-300">Developer</span>
          <span className="text-brand-400">{'/>'}</span>
        </div>
        <div className="absolute -top-4 -right-4 card px-3 py-2 rounded-xl text-xs font-mono border-violet-500/30 shadow-xl flex items-center gap-2">
...
function StashGridPreview() {
  const highlights = [
    { icon: '🏪', text: 'Dynamic store assignments — intelligently maps products to the right store location in real time.' },
    { icon: '🛒', text: 'Smart shopping list features — add, prioritize, and track items across multiple grocery runs.' },
    { icon: '📟', text: 'Custom kiosk display powered by a Raspberry Pi 3B and an Elecrow 5″ HDMI touchscreen — a physical in-store interface built from scratch.' },
  ]

  const tags = ['Python', 'Flask', 'Raspberry Pi', 'React', 'SQLite', 'Linux']

  return (
    <section id="dev-featured-project" className="py-24 px-6">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="card rounded-2xl p-0 overflow-hidden group hover:border-brand-500/60 transition-all duration-300 shadow-xl shadow-black/20">
          ...
          <div className="grid lg:grid-cols-5 gap-0">
              ...
              <div className="flex items-start justify-between gap-4">
                <div>
                  <div className="flex items-center gap-3 mb-2">
                    <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-brand-500 to-violet-600 flex items-center justify-center text-white text-lg shadow-lg">
            ...
            <div className="lg:col-span-2 bg-gradient-to-br from-brand-950/80 to-[#0f172a] flex items-center justify-center p-10 border-l border-[#334155] min-h-[260px]">
              <div className="text-center">
                <div className="mx-auto w-32 h-44 rounded-xl border-2 border-brand-500/40 bg-[#0f172a] shadow-lg shadow-brand-500/10 flex flex-col overflow-hidden">
                ...
                <p className="mt-4 text-xs font-mono text-slate-500">RPi 3B · Elecrow 5&quot;</p>
                <p className="text-[10px] text-slate-600 mt-1">Custom kiosk display</p>
              </div>
            </div>
          </div>
        </div>
